                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="proses_tambah.php">
                              <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" id="exampleInputNama" placeholder="Enter Nama">
                            </div>
                            <div class="form-group">
                        ...
                        <input type="submit" class="btn btn-info" role="button" value="Sign Up">
                        </form>
                    </div>
                </div>
            </div>
